 ...
 *
 *         GeeksforGeeks. “Introduction to Java Swing.” GeeksforGeeks, 15 Feb.
 *         2022,
 ...
 *
 *         www.leepoint.net /fred, Fred Swartz. “Java: Images - ImageIcon.”
 *         Puc-Rio.br, 2026,
 *         web.tecgraf.puc-rio.br/~ismael/Cursos/apostilas/Java-Notes/30GUI/20graphics/45imageicon.html.
 *         Accessed 9 Apr. 2026.
 * 
 *         Version: 2026-04-06
 */
...
/**
 * Purpose: The responsibility of ShelterGUI is to display adoptable cats and
 * allow users to view cat profiles and adopt cats.
 *
 * ShelterGUI is-a JFrame
 */
public class ShelterGUI extends JFrame
{
	...
	public ShelterGUI(AdoptionManager newAdoptionManager)
	{
		...
		for (int i = 0; i < adoptableCats.size(); i++)
		{
			...
			// add action listener so that clicking on a cat button will display
			// the cats profile
			catButton.addActionListener(e -> showCatProfile(cat));
			catButton.setPreferredSize(new Dimension(275, 275));

			// add components to cat panel, then add cat panel to cat button
			// panel
	...
	public void showCatProfile(Cat cat)
	{
		...
		JLabel nameLabel = new JLabel(
				"Here is some information about " + cat.getName());
		...
		JLabel socialLevelLabel = new JLabel(
				"Social Level: " + cat.getSocialLevel());
	...
	public void adoptCat(Cat cat, JFrame catFrame)
	{
		JOptionPane.showMessageDialog(this,
				"Congratulations! You have adopted " + cat.getName());
